...
if myHero.charName ~= "Shyvana" or not VIP_USER then return end
...
local UPDATE_NAME = "KawaiiShyvana"
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/Nii-sama/BoL/master/KawaiiShyvana.lua"
...
function OnLoad()
        ...
        Menu = scriptConfig("JustAhri","JustAhri")
               ...
               -- Menu.General:addParam("Farm","Farm",SCRIPT_PARAM_ONKEYDOWN,false,string.byte("V"))
                ...
                Menu.Extra:addParam("skin", "Skin", SCRIPT_PARAM_LIST, 3, {"Classic", "Ironscale", "Boneclaw", "Darkflame", "Ice Drake", "Championship"})
